...
\begin{table}[H]
    ...
    \begin{center}
    \scriptsize{\input{03_Tables/muestra_1porciento/twfe_wage_same_idrfc}}
    %\textit{Do file: twfe_rpci.do}
    \end{center}
\end{table}
...
\todo[inline]{Marco: I repeated this figure with the matched data, since the control figure has clear seasonality. I matched on baseline characteristics and compared attributed to each control worker the register date of their treatment match.}
}
