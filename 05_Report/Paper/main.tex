...
\\
\textbf{A: No, it increases the yearly wage SD (around 11\% of the baseline mean), it has a very small positive effect on the number of yearly wage raises, and it has no effect on the yearly number of wage changes or cuts.}
...
\begin{table}[H]
    ...
    \label{peer_rpci_rfc_rpci_dum}
    \begin{center}
    \scriptsize{\input{03_Tables/muestra_10porciento/peer_rpci_perc_rpci_exclu}}
    %\textit{Do file: peer_effects_empi_rpci.do}
    \end{center}
\end{table}
