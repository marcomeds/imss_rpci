...
\begin{equation}
    y_{it} = \gamma_{i} + \theta_{t}+ \beta_{k} \times \sum RPCI_{it} +\epsilon_{it}
\end{equation}
...
\midrule
\input 03_Tables/muestra_1porciento/twfe_alta
\end{tabular}
&
\begin{tabular}[t]{Hcc}
& \multicolumn{2}{c}{Formal Wage} \\
\midrule
\input 03_Tables/muestra_1porciento/twfe_sal_formal
\end{tabular}
&
\begin{tabular}[t]{Hcc}
& \multicolumn{2}{c}{Wage$^\dagger$} \\
\midrule
\input 03_Tables/muestra_1porciento/twfe_sal_cierre
\end{tabular}
&
\begin{tabular}[t]{Hcc}
& \multicolumn{2}{c}{Log Wage$^\dagger$} \\
\midrule
\input 03_Tables/muestra_1porciento/twfe_log_sal_cierre
\end{tabular}
\tabularnewline 
\bottomrule
\bottomrule
